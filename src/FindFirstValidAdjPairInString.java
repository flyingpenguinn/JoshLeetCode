...
public class FindFirstValidAdjPairInString {
    ...
    public static void main(String[] args) {
        System.out.println(new FindFirstValidAdjPairInString().maxFreeTime(21,2, ArrayUtils.read1d("18,20"), ArrayUtils.read1d("20, 21")));
    }
}
