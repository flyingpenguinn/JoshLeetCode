...
public class ErectingTheFenceII {
    //https://www.nayuki.io/page/smallest-enclosing-circle
    public double[] outerTrees(int[][] ps) {
    ...
    public static Circle makeCircle(List<Point> points) {
        ...
        for (int i = 0; i < shuffled.size(); i++) {
            ...
            if (c == null || !c.contains(p))
                c = makeCircleOnePoint(shuffled.subList(0, i), p);
        }
        return c;
    }
...
final class Point {
    ...
    public static void main(String[] args) {
        System.out.println(new ErectingTheFenceII().outerTrees(ArrayUtils.read("[[1,2],[2,2],[4,2]]")));
    }
